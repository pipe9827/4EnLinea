class CuatroEnLinea {
    ...
    animateToken(row: number, col: number) {
        ...
        const interval = setInterval(() => {
            if (tempRow > 0) {
                const prevCell = document.querySelector(`.cell[data-row='${tempRow - 1}'][data-column='${col}']`) as HTMLElement;
                prevCell.style.backgroundColor = "white";
            }
            
            const currentCell = document.querySelector(`.cell[data-row='${tempRow}'][data-column='${col}']`) as HTMLElement;
